...
OUTPUT_DIR = 'C:/Users/danim/OneDrive/Ambiente de Trabalho/dataset/train/mask_0' # Changed directory name for clarity
OFFSET_FACTOR = 0.1
...
if target_areas.empty:
    ...
    for index, row in target_areas.iterrows():
        ...
        for i_frame, (f_minx, f_miny, f_maxx, f_maxy) in enumerate(frames_for_feature):
            ...
            # Save the figure
            filename = os.path.join(OUTPUT_DIR, f'{ATTRIBUTE_COLUMN}_{TARGET_VALUE}_{feature_id}_mask_frame_{i_frame+1}.png')
