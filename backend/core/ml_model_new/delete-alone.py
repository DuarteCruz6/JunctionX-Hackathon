...
folder_to_clean = "C:/Users/danim/OneDrive/Ambiente de Trabalho/JunctionX-Hackathon/backend/core/ml_model_new/dataset/images/train"

# Folder 2: The reference folder. Files in here are used for the check.
# If a file in 'folder_to_clean' doesn't have a matching name here, it gets deleted.
# Example for Windows: "C:\\Users\\YourName\\Desktop\\Reference_Data"
# Example for macOS/Linux: "/home/yourname/documents/reference"
reference_folder = "C:/Users/danim/OneDrive/Ambiente de Trabalho/JunctionX-Hackathon/backend/core/ml_model_new/dataset/labels/train"
