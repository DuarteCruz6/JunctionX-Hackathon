...
def create_black_mask(image_path, save_path):
    """Creates a completely black mask with the same dimensions as the input image."""
    with Image.open(image_path) as img:
        width, height = img.size
        # Create an array filled with 0 (black)
